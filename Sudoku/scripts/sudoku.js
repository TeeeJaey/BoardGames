...
$(document).ready(function () {
    ...
    if (game.autoLoadGame()) mainContentVue.controls = 0;
    ...
    $(document).on("keydown", function (e) {
        ...
        e.preventDefault();
        if (btnClicked < 10) checkNumberKey(btnClicked);
        else checkArrowKey(btnClicked);
    });
    ...
    $(document.body).on("click", ".cell", function () {
        ...
        if (this.id == selectedCellID) selectedCellID = null;
        else {
            newCell.isSelected = true;
